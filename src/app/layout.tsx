...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Découvrez la révolution des solutions numériques conçues par et pour les Africains, célébrant fièrement nos racines culturelles. Plongez dans l'écosystème dynamique des produits africains lors de l'Africa Product Keynote #APK2024, dévoilant l'innovation, la créativité et l'avenir numérique du continent.",
    type: "article",
