    ...
    <section className="  bg-[#FDFBFC]    md:min-h-screen flex items-center">
      <div className="md:w-9/12 w-11/12 mx-auto">
        <Heading>
          <h3
            data-aos="fade-up"
            className="section-title  mx-auto md:text-center my-14"
          >
            Pour quoi <span className="">ne pas rater </span>{" "}
            <br /> cet <span className="text-primary"> evenement</span> ?
          </h3>
        </Heading>
